	...
	<div class="container-lg max-w-screen-xl">
		<div class="row align-items-center">
			<div class="col-lg-6 order-lg-1 ms-auto d-none d-lg-block">
				<div class="mb-5 mb-lg-0 w-11/10 position-relative">
					...
					<div class="svg-fluid position-relative overlap-10">
						<svg id="ab47acfe-844d-4101-aa7b-df38aa50dbe4" data-name="Layer 1"
							xmlns="http://www.w3.org/2000/svg" width="971.0518"
							height="628.38145" viewBox="0 0 971.0518 628.38145">
                <path
                ...
                <rect x="706.5518" y="542.50808" width="67" height="3"
								fill="#e6e6e6" />
                <path
                ...
                <circle cx="451.48125" cy="213.98538" r="36.39575"
								fill="#2f2e41" />
                <path
                ...
                <circle cx="383.4705" cy="106.99576" r="106.91249"
								fill="#2f2e41" />
                <path
								...
								transform="translate(-114.4741 -135.80928)" fill="#2f2e41" />
                <circle cx="382.5645" cy="144.14332" r="68.85889"
								fill="#ffb8b8" />
                <path
                ...
                <path
								...
								transform="translate(-114.4741 -135.80928)" fill="#2f2e41" />
                <circle cx="301.18217" cy="479.53178" r="9.06039"
								fill="#6c63ff" />
                <circle cx="482.38982" cy="488.59217" r="9.06038"
								fill="#6c63ff" />
                <polygon
								...
								fill="#2f2e41" />
                <ellipse cx="312.79955" cy="129.6467" rx="5.43622"
								ry="9.96642" fill="#ffb8b8" />
                <ellipse cx="452.32945" cy="129.6467" rx="5.43622"
								ry="9.96642" fill="#ffb8b8" />
                <path
                ...
                <rect y="626.38145" width="971.0518" height="2"
								fill="#3f3d56" />
                <path
								...
								transform="translate(-114.4741 -135.80928)" fill="#3f3d56" />
                <circle cx="362.99998" cy="432.38142" r="25"
								fill="#6c63ff" />
                <polygon
			...
			<div class="col-lg-6 order-md-0">
				<!-- Surtitle -->
				<h5 class="h5 mb-5 text-uppercase text-warning mb-5">EMS
					</h5>
				<!-- Heading -->
				<h1 class="ls-tight font-bolder display-3 mb-5">Employee
					Management System</h1>
				<!-- Text -->
				<p class="lead mb-10">Accelerate Your agency's growth.
					</p>
				<!-- Buttons -->
				<div class="mx-n2">
					<a href="#" class="btn btn-lg btn-primary shadow-sm mx-2 px-lg-8">
						Get started </a> <a href="#"
						class="btn btn-lg btn-neutral mx-2 px-lg-8"> Learn more </a>
				</div>
			</div>
		</div>
	</div>
